...
if($_POST){
    ...
    if(empty($nama_petugas)){
        ...
        $insert=mysqli_query($conn,"insert into petugas (id_petugas,nama_petugas,username,password,level) value ('".$id_petugas."','".$nama_petugas."','".$username."','".md5($password)."','".$level."')");
        if($insert){
